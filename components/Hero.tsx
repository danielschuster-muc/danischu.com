...
const Hero = () => {
  return (
    <header className="container mx-auto flex h-[calc(100vh-80px)] px-10 py-10 text-gray-700 dark:text-white lg:h-[calc(100vh-68px)]">
      <div className="flex flex-col justify-between lg:w-1/2">
        ...
        <div className="flex flex-col space-y-1 text-lg ">
          ...
          <a href="https://linkedin.com/in/danielschuster-muc" className="flex items-center">
            ...
            <span className="hover:text-gray-600 hover:underline">danielschuster-muc</span>
          </a>
          <a href="mailto:contact@danischu.com" className="flex items-center">
            <FaEnvelope className="mr-2" />
            <span className="hover:text-gray-600 hover:underline">contact@danischu.com</span>
          </a>
        </div>
      </div>
